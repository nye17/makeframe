# Last-modified: 14 Apr 2014 16:13:55
# Ying ZU @ TDLI/SJTU(yingzu@sjtu.edu.cn)

# docstring status: done.


import matplotlib.pyplot as plt
import numpy as np

""" Make Multiple Axes for Matplotlib.
"""

# ---------------------------------------------------------------------
#   Making multiple axes with ease.
# ---------------------------------------------------------------------
...
if __name__ == "__main__":
    fig, axes, ncol, nrow = getHandyFrames(geometry='3x4-1x1', wid=6, xgut=0.06, ygut=0.04, x0=0.10, x1=1.01, y0=0.04, y1=0.98)
    print(ncol, nrow)
    ax = axes[0]
    print(len(axes))
    ax.plot([1,4], [1,4], 'r' )
    # do something with ax
    figure_handler(fig, None, None)
